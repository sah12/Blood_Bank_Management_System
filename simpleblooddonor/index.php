                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>kalpana c</b> deleted account</h4>
                                                <p>
                                    ...
                                    <li>
                                        <a href="javascript:void(0);">
                                            ...
                                            <div class="menu-info">
                                                <h4><b>divya</b> commented your post</h4>
                                                <p>
                ...
                <ul class="list">
                    ...
                    <li>
					 ...
					 <li>
                        ...
                        <ul class="ml-menu">
                                <li>
                                    <a href="addpatient.html">Create patient</a>
                                </li>
                                <li>
                                    <a href="editpatient.php">Edit patientDetails</a>
                                </li>
                                <li>
                                    <a href="viewpatient.php">View patient</a>
                                </li>
                                <li>
                                    <a href="deletepatient.php">Remove patient</a>
                                </li>
					...
					<li>
                        ...
                        <ul class="ml-menu">
                                <li>
                                    <a href="addtest.html">Create test</a>
                                </li>
                                <li>
                                    <a href="edittest.php">Edit test</a>
                                </li>
                                <li>
                                    <a href="viewtest.php">view test info</a>
                                </li>
                  	...
                  	<li>
                        ...
                        <ul class="ml-menu">
                                <li>
                                    <a href="addbank.html">Create bank</a>
                                </li>
                                <li>
                                    <a href="editbank.php">Edit bank</a>
                                </li>
                                <li>
                                    <a href="viewbank.php">view bank info</a>
                                </li>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-box bg-yellow hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">no.of.tests</div>
                          
                        </div>
                        <?php 
                            include 'counttest.php';
                            ?>
                    </div>
                </div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">banks available</div>
                          
                        </div>
                        <?php 
                            include 'countbank.php';
                            ?>
                    </div>
                </div>
