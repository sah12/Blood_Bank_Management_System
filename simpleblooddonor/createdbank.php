        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">sahanashanbhag7.com</div>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="edittest.php">Edit test Details</a>
                            </li>
                            <li>
...
$qry = "insert into bloodbank(id,name,address,contact) values ('$id','$name','$address','$contact')";
$result = mysqli_query($conn,$qry); //query executes

if(!$result){
    echo"ERROR";
}else {
    echo" <div style='text-align: center'><h1>bank details inserted</h1>";
