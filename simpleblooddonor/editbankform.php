...
include 'conn.php';
$id=$_GET['id'];
$qry= "select * from bloodbank where id='$id'";
        ...
        <form role="form" action = "editedbank.php" method = "post">
          <div class="box-body">
            ...
            <label for="exampleInputEmail1">bank id</label>
              <input type="text" class="form-control" name="id"  value='<?php echo $row['id']; ?>' placeholder="Enter bank id" required>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="address"  value='<?php echo $row['address']; ?>' placeholder="Enter bank address" required>
              </div> 

              <div class="form-group">
                <label for="exampleInputPassword1">contact</label>
                <input type="text" class="form-control" name="contact"  value='<?php echo $row['contact']; ?>' placeholder="Enter bank contact" required>
              </div>
