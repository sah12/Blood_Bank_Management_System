        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    ...
                    <div class="email">sahanashanbhag7@gamail.com</div>
                ...
                <ul class="list">
					...
					<li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="editpatient.php">Edit patient Details</a>
                            </li>
                            <li>
...
$qry = "insert into patient(patientname,bloodgroup,id,contact,status) values ('$patientname','$bloodgroup','$id','$contact','$status')";
$result = mysqli_query($conn,$qry); //query executes

if(!$result){
    echo"ERROR";
}else {
    echo" <div style='text-align: center'><h1>patient record Created</h1>";
